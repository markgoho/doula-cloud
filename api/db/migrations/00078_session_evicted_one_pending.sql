...
-- (00063) give their own kinds, restated for 00077's 'session_evicted',
...
-- insert commits.
--
-- Its own migration, not appended to 00077: see 00077's own comment, and
...
-- +goose Down
-- Dropped first (before 00077's own down migration rebuilds
