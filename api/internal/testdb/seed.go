...
// sets ending_reason to 'care_complete' -- #253's engagements_completed_has_reason
// CHECK demands one on every completed row, and a fixture that does not
// care which reason just needs any legal one.
