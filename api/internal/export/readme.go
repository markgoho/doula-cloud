...
func writeReadme(ctx context.Context, tx *sql.Tx, zw *zip.Writer, practiceName, staffID string, entities []entity) error {
	...
	fmt.Fprintf(&b, "Run by %s, %s.\n\n", staffName, time.Now().UTC().Format("2006-01-02T15:04:05Z"))
