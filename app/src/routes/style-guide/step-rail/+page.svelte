	...
	const steps: JourneyStep[] = [
		{
			...
			status: 'completed',
			questions: [
				{ label: "Sarah's name", href: '/style-guide/step-rail' },
		...
		},
		{
			...
			status: 'current',
			questions: [
				{ label: 'Email address', href: '/style-guide/step-rail' },
				{ label: 'Phone number', href: '/style-guide/step-rail' }
			]
		},
		{ label: 'Where Sarah lives', href: '/style-guide/step-rail#lives', status: 'todo' },
...
<stack-l space="var(--space-6)">
	...
	<container-l>
		<div class="frame">
			<StepRail journey="Adding a client" {steps} allStepsHref="/style-guide/step-rail" />
		</div>
	</container-l>
