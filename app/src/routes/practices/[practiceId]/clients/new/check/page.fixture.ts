/*
 * The summary that ends the sequence (#466, GOV.UK Check answers).
 *
...
export const fixture: RouteFixture = {
	name: 'Checking a Client’s details',
	component: Page,
	params: { practiceId },
	url: 'https://example.test/practices/practice-1/clients/new/check',
	readyText: 'Check '
};
