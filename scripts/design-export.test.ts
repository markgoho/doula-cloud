...
describe("renderExport", () => {
      ...
      doc([
        {
          ...
          name: "Sign in",
          children: [
            { type: "text", id: "t1", name: "Heading", content: "Welcome back" },
            { type: "text", id: "t2", name: "Subheading", content: "Sign in to continue" },
          ],
        },
      ]),
    );
  ...
  test("marks a reusable artboard so a component reads differently from a screen", () => {
    const out = renderExport(
      doc([{ type: "frame", id: "a1", name: "QuickCard", reusable: true, children: [] }]),
    );
  ...
  test("resolves a ref to the reusable component it instantiates, by name", () => {
    const out = renderExport(
      doc([
        { type: "frame", id: "comp1", name: "StaffTopBar", reusable: true, children: [] },
        {
          type: "frame",
          id: "a1",
          name: "Screen",
      ...
      doc([
        {
          ...
          id: "a1",
          name: "Screen",
          children: [{ type: "ref", id: "r1", name: "Ghost", ref: "missing-id" }],
        },
      ]),
    );
      ...
      doc([
        {
          ...
          name: "QuickCard",
          reusable: true,
          children: [{ type: "text", id: "label1", name: "Label", content: "placeholder" }],
        },
        {
          type: "frame",
          id: "a1",
      ...
      doc([
        {
          ...
          id: "a1",
          name: "Screen",
          children: [{ type: "text", id: "t1", content: "Hello", fill: "$text", fontSize: 16 }],
        },
      ]),
    );
      ...
      doc([
        {
          ...
          id: "a1",
          name: "Screen",
          children: [{ type: "icon", id: "i1", icon: "users", library: "lucide" }],
        },
      ]),
    );
      ...
      doc([
        {
          ...
          id: "a1",
          name: "Screen",
          children: [{ type: "text", id: "t1", name: "Error", content: "Required", enabled: false }],
        },
      ]),
    );
  ...
  test("shows a theme axis pinned on a ref or frame", () => {
    const out = renderExport(
      doc([
        { type: "frame", id: "comp1", name: "CloudMark", reusable: true, children: [] },
        {
          type: "frame",
          id: "a1",
          name: "Screen",
          children: [
            { type: "ref", id: "r1", name: "Mark", ref: "comp1", theme: { size: "sm" } },
          ],
        },
      ]),
    );
      ...
      doc([
        {
          ...
          name: "QuickCard",
          reusable: true,
          children: [{ type: "frame", id: "target1", name: "Icon", children: [] }],
        },
        {
          type: "frame",
          id: "a1",
