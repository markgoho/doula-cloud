...
| Obviously Awesome | April Dunford, 2019 | `Obviously Awesome.pdf` | read-back |
| Building a StoryBrand 2.0 | Donald Miller, 2025 updated edition | `Building a StoryBrand 2.pdf` | read-back |
| Lean Marketing | Allan Dib, 2024 | `Lean Marketing.pdf` | read-back |
| The 1-Page Marketing Plan | Allan Dib, 2018 edition | `The 1-Page Marketing Plan.pdf` | read-back |
| The Mom Test | Rob Fitzpatrick, 2013 | `The Mom Test.pdf` | read-back |
| Competing Against Luck | Clayton M. Christensen, Taddy Hall, Karen Dillon, David S. Duncan, 2016 | `Competing Against Luck.pdf` | read-back |
| Forget the Funnel | Georgiana Laudi and Claire Suellentrop, 2023 | `Forget the Funnel.pdf` | read-back |
| Marketing Made Simple | Donald Miller and J.J. Peterson, 2020 | `Marketing Made Simple.pdf` | read-back |
| This Is Marketing | Seth Godin, 2018 | `This Is Marketing.pdf` | read-back |
| Start Small, Stay Small | Rob Walling, 2010 | `Start small, stay small.pdf` | read-back |
| Software as a Science | Dan Martell, Matt Verlaque, Johnny Page, Marcel Petitpas, 2024 | `Software as a Science.pdf` | read-back |
| The Lean Startup | Eric Ries, 2011 | `The Lean Startup.pdf` | read-back |
| The Four Steps to the Epiphany | Steve Blank, 2013 second edition | `The four steps to the epiphany.pdf` | read-back |
| The Startup Owner's Manual | Steve Blank and Bob Dorf, 2012 | `The startup owner's manual.pdf` | read-back |
| Zero to One | Peter Thiel with Blake Masters, 2014 | `Zero to One.pdf` | read-back |
| Company of One | Paul Jarvis, 2019 | `Company of One.pdf` | read-back |
| Buy Back Your Time | Dan Martell, 2023 | `Buy Back Your Time.pdf` | read-back |
| Entrepreneur Revolution | Daniel Priestley, 2024 third edition | `Entrepreneur Revolution.pdf` | read-back |
| The Voltage Effect | John A. List, 2022 | `The voltage effect.pdf` | read-back |
| Thinking in Bets | Annie Duke, 2018 | `Thinking in Bets.pdf` | read-back |
