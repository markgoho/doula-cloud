...
| Obviously Awesome | April Dunford, 2019 | `Obviously Awesome.pdf` | synthesized |
| Building a StoryBrand 2.0 | Donald Miller, 2025 updated edition | `Building a StoryBrand 2.pdf` | synthesized |
| Lean Marketing | Allan Dib, 2024 | `Lean Marketing.pdf` | synthesized |
| The 1-Page Marketing Plan | Allan Dib, 2018 edition | `The 1-Page Marketing Plan.pdf` | synthesized |
| The Mom Test | Rob Fitzpatrick, 2013 | `The Mom Test.pdf` | synthesized |
| Competing Against Luck | Clayton M. Christensen, Taddy Hall, Karen Dillon, David S. Duncan, 2016 | `Competing Against Luck.pdf` | synthesized |
| Forget the Funnel | Georgiana Laudi and Claire Suellentrop, 2023 | `Forget the Funnel.pdf` | synthesized |
| Marketing Made Simple | Donald Miller and J.J. Peterson, 2020 | `Marketing Made Simple.pdf` | synthesized |
| This Is Marketing | Seth Godin, 2018 | `This Is Marketing.pdf` | synthesized |
| Start Small, Stay Small | Rob Walling, 2010 | `Start small, stay small.pdf` | synthesized |
| Software as a Science | Dan Martell, Matt Verlaque, Johnny Page, Marcel Petitpas, 2024 | `Software as a Science.pdf` | synthesized |
| The Lean Startup | Eric Ries, 2011 | `The Lean Startup.pdf` | synthesized |
| The Four Steps to the Epiphany | Steve Blank, 2013 second edition | `The four steps to the epiphany.pdf` | synthesized |
| The Startup Owner's Manual | Steve Blank and Bob Dorf, 2012 | `The startup owner's manual.pdf` | synthesized |
| Zero to One | Peter Thiel with Blake Masters, 2014 | `Zero to One.pdf` | synthesized |
| Company of One | Paul Jarvis, 2019 | `Company of One.pdf` | synthesized |
| Buy Back Your Time | Dan Martell, 2023 | `Buy Back Your Time.pdf` | synthesized |
| Entrepreneur Revolution | Daniel Priestley, 2024 third edition | `Entrepreneur Revolution.pdf` | synthesized |
| The Voltage Effect | John A. List, 2022 | `The voltage effect.pdf` | synthesized |
| Thinking in Bets | Annie Duke, 2018 | `Thinking in Bets.pdf` | synthesized |
