...
| --- | --- | --- | --- | --- |
| HS-G1 | 2 | Experience | **Closed 2026-09-20, [#1244](https://github.com/markgoho/doula-cloud/issues/1244).** [#300](https://github.com/markgoho/doula-cloud/issues/300) closed as already-implemented by #617 (ADR-0026): the accept-invite screen has no account-mode question left to get wrong — a single **Continue** button, no "new here" / "already have an account" choice. | [#300](https://github.com/markgoho/doula-cloud/issues/300) |
