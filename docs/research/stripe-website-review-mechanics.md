...
Absences were checked mechanically, not by recollection. Every page named in the roster at the end of this document was fetched to a local file — support-centre articles as their extracted source Markdown, docs pages as their `.md` form, the Services Agreement as stripped HTML text — concatenated, and searched case-insensitively for the term lists quoted in each absence below. Where a term does occur but not in the sense at issue, the hit is named rather than suppressed.
