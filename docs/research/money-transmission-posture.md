...
3. **No platform balance holding Client money.** No top-ups, no `connect_reserved` strategy, no "we hold it until the Engagement completes". Escrow is on Stripe's **Restricted** business list and is close to the center of what article 13-B regulates.
