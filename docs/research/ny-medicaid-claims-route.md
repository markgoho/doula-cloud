...
**Six years is the fee-for-service floor, and it is not the longest period a doula can be held to.** DOH's own Doula Manual Policy Guidelines, revised May 2025, says it in one paragraph: "FFS records must be maintained for six years following the date of payment... Medicaid Managed Care (MMC) plans are required to maintain medical records for ten years after the date of service, and in the case of a minor, for ten years after the date of service or three years after majority, whichever occurs later. Therefore, MMC plans may require in-network Doulas to maintain medical records for ten years after the date of service, and in the case of a minor, for ten years after the date of service or three years after the majority, whichever occurs later. Doulas must verify record-keeping requirements for each MMC plan they contract with." (https://www.health.ny.gov/health_care/medicaid/redesign/doulapilot/provider_manual.htm). The benefit was added to Managed Care on 1 April 2025, so this is the ordinary case rather than the edge one, and a pregnant minor is not a hypothetical in this benefit. The period is therefore **per payer contract**, not a constant — a retention model that hard-codes six years is already wrong at the second MMC plan, never mind at the second state.

**The regulation behind the Certification Statement, and why the clock cannot be trusted to expire.** 18 NYCRR §504.3(a) is the enrolling provider's own agreement "to keep for a period of six years from the date the care, services or supplies were furnished, all records necessary to disclose the nature and extent of services furnished" (https://www.law.cornell.edu/regulations/new-york/18-NYCRR-504.3). 18 NYCRR §517.3(b)(1) states the same duty for a fee-for-service provider as "six years from the date the care, services or supplies were furnished or billed, whichever is later", and adds two clauses the Certification Statement does not: the limitation "does not apply to situations in which fraud may be involved or where the provider or an agent thereof prevents or obstructs an audit", and notice of the department's intent to audit **tolls** the six-year period (https://www.law.cornell.edu/regulations/new-york/18-NYCRR-517.3). Software must therefore never destroy a claim-supporting record automatically at expiry; expiry is a state a person acts on.

**What that adds up to for the software:** the duration of every perinatal visit must be recorded and must support the 30-minute minimum; the recommendation or the reliance on the standing order must be recorded per client; and everything must survive at least six years past payment, longer where an MMC contract or a minor member says so. See [#1094](https://github.com/markgoho/doula-cloud/issues/1094) for how this collides with ADR-0027's Erasure and ADR-0031's Practice-Deletion cascade.
...
**Claim.MD: quote-only.** Claim.MD publishes a license agreement at https://www.claim.md/hipaa.html which returned 403 to automated fetching, so I could not read it and will not characterize it. Claim.MD does publish that it maintains HITRUST CSF r2 certification (first certified 2023, maintained as of June 2026) — https://www.claim.md/news/claimmd-maintains-hitrust-r2-certification-and-strongly-encourages-vendors-to-adopt-similar-security-practices-to-strengthen-protection-of-sensitive-claims-data — which is evidence of a security program, not a BAA. Whether Claim.MD will sign a BAA, and on what terms, has to be asked of Claim.MD directly.
...
7. **Whether Claim.MD will sign a BAA, and on what terms.** Their license agreement page 403s to automated fetching. **Ask:** Claim.MD directly.
